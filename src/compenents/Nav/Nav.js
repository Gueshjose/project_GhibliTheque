...
function Nav() {
    return (
            <div className="w-full flex jus h-[12vh] shadow-md bg-slate-100 border-0 shadow-slate-600 sticky top-0 z-30">
                ...
                <button className="w-[8%] h-[5vh] cursor-ghibliC my-auto text-sm rounded-3xl relative active:scale-90 font-bold  bg-black text-slate-50 border-2 border-slate-50 shadow-md shadow-slate-600">
