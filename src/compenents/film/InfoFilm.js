...
function InfoFilm(props){
    ...
    return(
        <div className="w-full h-full">
            <div className="w-full h-[55vh]  text-centerv overflow-hidden z-0 shadow-md shadow-slate-600">
                ...
                <h1 className="text-6xl z-10 absolute top-48 left-[40%] font-extrabold underline text-white drop-shadow-[3px_2px_5px_rgba(0,0,0,0.6)]">{props.films[params.id].title.toUpperCase()}</h1>
                <h2 className="text-2xl z-10 absolute top-64 left-[45%] italic font-bold text-white drop-shadow-[2px_1px_3px_rgba(0,0,0,0.8)]">{props.films[params.id].original_title} / {props.films[params.id].original_title_romanised}</h2>
                <div className="grid grid-cols-12 grid-rows-2  z-10 absolute font-semibold top-80 text-white w-full drop-shadow-[3px_2px_5px_rgba(0,0,0,0.6)]">
                    <p className='col-start-6 col-span-6 col'>
                        PRODUCER: {props.films[params.id].producer}
                    </p>
                    <p className='col-start-7  col-span-5'>
            ...
            <div className=' w-full h-[40vh] '>
                ...
                <div className="relative p-3 grid grid-cols-12 mt-12">
                   <blockquote  className='relative rounded-md text-gray-500 italic  bg-slate-100 col-start-6 col-span-6 text-justify dark:bg-[#201F39] dark:text-slate-50  text-xl p-5 border-[1px] border-transparent shadow-md shadow-black'>
                    ...
                    <p className="absolute text-xl font-bold text-blue-600 top-[-60vh] left-[91vw] z-20 drop-shadow-[1px_1px_1px_rgba(0, 0, 0, 0.8)]" >
